...
module LPC_qsys_mm_interconnect_0 (
		...
		input  wire [31:0] ddr3_read_master_ddr3_avalon_master_address,                 //                   ddr3_read_master_ddr3_avalon_master.address
	...
	wire          ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_waitrequest;   // ddr3_read_master_ddr3_avalon_master_agent:av_waitrequest -> ddr3_read_master_ddr3_avalon_master_translator:uav_waitrequest
	wire   [15:0] ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_readdata;      // ddr3_read_master_ddr3_avalon_master_agent:av_readdata -> ddr3_read_master_ddr3_avalon_master_translator:uav_readdata
	wire          ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_debugaccess;   // ddr3_read_master_ddr3_avalon_master_translator:uav_debugaccess -> ddr3_read_master_ddr3_avalon_master_agent:av_debugaccess
	wire   [31:0] ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_address;       // ddr3_read_master_ddr3_avalon_master_translator:uav_address -> ddr3_read_master_ddr3_avalon_master_agent:av_address
	wire          ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_read;          // ddr3_read_master_ddr3_avalon_master_translator:uav_read -> ddr3_read_master_ddr3_avalon_master_agent:av_read
	wire    [1:0] ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_byteenable;    // ddr3_read_master_ddr3_avalon_master_translator:uav_byteenable -> ddr3_read_master_ddr3_avalon_master_agent:av_byteenable
	wire          ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_readdatavalid; // ddr3_read_master_ddr3_avalon_master_agent:av_readdatavalid -> ddr3_read_master_ddr3_avalon_master_translator:uav_readdatavalid
	wire          ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_lock;          // ddr3_read_master_ddr3_avalon_master_translator:uav_lock -> ddr3_read_master_ddr3_avalon_master_agent:av_lock
	wire          ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_write;         // ddr3_read_master_ddr3_avalon_master_translator:uav_write -> ddr3_read_master_ddr3_avalon_master_agent:av_write
	wire   [15:0] ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_writedata;     // ddr3_read_master_ddr3_avalon_master_translator:uav_writedata -> ddr3_read_master_ddr3_avalon_master_agent:av_writedata
	wire    [1:0] ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_burstcount;    // ddr3_read_master_ddr3_avalon_master_translator:uav_burstcount -> ddr3_read_master_ddr3_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                      // rsp_mux:src_valid -> ddr3_read_master_ddr3_avalon_master_agent:rp_valid
	wire   [85:0] rsp_mux_src_data;                                                                       // rsp_mux:src_data -> ddr3_read_master_ddr3_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                      // ddr3_read_master_ddr3_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                    // rsp_mux:src_channel -> ddr3_read_master_ddr3_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                              // rsp_mux:src_startofpacket -> ddr3_read_master_ddr3_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                // rsp_mux:src_endofpacket -> ddr3_read_master_ddr3_avalon_master_agent:rp_endofpacket
	...
	wire          ddr3_read_master_ddr3_avalon_master_agent_cp_valid;                                     // ddr3_read_master_ddr3_avalon_master_agent:cp_valid -> router:sink_valid
	wire   [85:0] ddr3_read_master_ddr3_avalon_master_agent_cp_data;                                      // ddr3_read_master_ddr3_avalon_master_agent:cp_data -> router:sink_data
	wire          ddr3_read_master_ddr3_avalon_master_agent_cp_ready;                                     // router:sink_ready -> ddr3_read_master_ddr3_avalon_master_agent:cp_ready
	wire          ddr3_read_master_ddr3_avalon_master_agent_cp_startofpacket;                             // ddr3_read_master_ddr3_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          ddr3_read_master_ddr3_avalon_master_agent_cp_endofpacket;                               // ddr3_read_master_ddr3_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          ddr3_interface_avl_1_agent_rdata_fifo_src_valid;                                        // DDR3_interface_avl_1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] ddr3_interface_avl_1_agent_rdata_fifo_src_data;                                         // DDR3_interface_avl_1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          ddr3_interface_avl_1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter:in_0_ready -> DDR3_interface_avl_1_agent:rdata_fifo_src_ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) ddr3_read_master_ddr3_avalon_master_agent (
		.clk                   (clk_50M_clk_clk),                                                                        //       clk.clk
		.reset                 (ddr3_read_master_reset_sink_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.av_address            (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (ddr3_read_master_ddr3_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (ddr3_read_master_ddr3_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (ddr3_read_master_ddr3_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (ddr3_read_master_ddr3_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (ddr3_read_master_ddr3_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (ddr3_read_master_ddr3_avalon_master_agent_cp_ready),                                     //          .ready
	...
	LPC_qsys_mm_interconnect_0_router router (
		.sink_ready         (ddr3_read_master_ddr3_avalon_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (ddr3_read_master_ddr3_avalon_master_agent_cp_valid),         //          .valid
		.sink_data          (ddr3_read_master_ddr3_avalon_master_agent_cp_data),          //          .data
		.sink_startofpacket (ddr3_read_master_ddr3_avalon_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (ddr3_read_master_ddr3_avalon_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_50M_clk_clk),                                            //       clk.clk
		.reset              (ddr3_read_master_reset_sink_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	LPC_qsys_mm_interconnect_0_router_001 router_001 (
	...
	LPC_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (ddr3_interface_avl_1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (ddr3_interface_avl_1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (ddr3_interface_avl_1_agent_rdata_fifo_src_ready),         //         .ready
