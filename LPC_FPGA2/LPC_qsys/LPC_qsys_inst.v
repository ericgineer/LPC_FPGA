	LPC_qsys u0 (
		...
		.lpcdec_rst                   (<connected-to-lpcdec_rst>),                   //                    .rst
		...
		.lpcenc_freq_count            (<connected-to-lpcenc_freq_count>),            //                    .freq_count
		.lpcenc_rst                   (<connected-to-lpcenc_rst>),                   //                    .rst
		...
		.read_master_stream_d_rst     (<connected-to-read_master_stream_d_rst>),     //                    .d_rst
		...
		.write_master_stream_d_in_clk (<connected-to-write_master_stream_d_in_clk>), //                    .d_in_clk
		.lpc_clk_clk                  (<connected-to-lpc_clk_clk>)                   //             lpc_clk.clk
	);
